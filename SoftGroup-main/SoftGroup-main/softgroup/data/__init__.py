...
from .cabbage import CabbageDataset
from .kitti import KITTIDataset
from .s3dis import S3DISDataset
from .scannetv2 import ScanNetDataset
from .stpls3d import STPLS3DDataset

__all__ = ['S3DISDataset', 'ScanNetDataset', 'CabbageDataset', 'build_dataset']
...
def build_dataset(data_cfg, logger):
    ...
    elif data_type == 'cabbage':
        return CabbageDataset(**_data_cfg)
