...
__global__ void get_iou_cuda_(int nInstance, int nProposal, int *proposals_idx, int *proposals_offset, int64_t *instance_labels, int *instance_pointnum, float *proposals_iou){
...
void get_iou_cuda(int nInstance, int nProposal, int *proposals_idx, int *proposals_offset, int64_t *instance_labels, int *instance_pointnum, float *proposals_iou){
